            ...
            <transition name="left-fade" mode="out-in">
                ...
                >
                    ...
                    <div v-if="settings.showDate" class="left-date">
                        {{ currentDate
                        }}<span v-if="clockAmPm" class="ampm-tag">{{
                            clockAmPm
                        }}</span>
                    </div>
                </div>
                    ...
                    >
                        ...
                        <div class="control-buttons">
                            <button
                                class="ctrl-btn"
                                :class="
                                    stopwatchRunning ? 'btn-pause' : 'btn-start'
                                "
                    ...
                    >
                        ...
                        <div class="control-buttons">
                            <button
                                class="ctrl-btn"
                                :class="
                                    countdownRunning ? 'btn-pause' : 'btn-start'
                                "
                        ...
                        <div class="preset-chips">
                            ...
                            <button class="chip" @click="applyPreset(10)">
                                <svg class="icon" aria-hidden="true">
                                    <use
                                        xlink:href="#icon-mingxiangfangsong-ico"
                                    ></use></svg
                                >10分钟
                            </button>
                        </div>
    ...
    computed: {
        ...
        formattedCountdown() {
            ...
            return formatCountdown({
                ...
                forceHours:
                    this.countdownInitHours > 0 || this.countdownHours > 0,
            });
        },
    },
    ...
    methods: {
        ...
        startRaf() {
            const loop = () => {
                ...
                if (this.countdownRunning && this._cdSecStart !== undefined) {
                    const elapsed = now - this._cdSecStart;
                    // elapsed 在 0~1000ms 之间，转为倒计时方向（从0倒到999）
                    this.countdownMs = elapsed % 1000;
                }
        ...
        toggleCountdown() {
            if (this.countdownRunning) {
                clearInterval(this.countdownInterval);
                clearInterval(this.countdownMsInterval);
            ...
            this.countdownInterval = setInterval(() => {
                ...
                const remain =
                    ...
                    this.countdownMinutes * 60 +
                    this.countdownSeconds;
                this.countdownEnding = remain <= 10;
                // 每整秒重置毫秒段起始点
                this._cdSecStart = Date.now();
                this.countdownMs = 0;
            }, 1000);
        ...
        clampCountdown() {
            ...
            this.countdownMinutes = clampCountdownValue(
                this.countdownMinutes,
                59,
            );
            this.countdownSeconds = clampCountdownValue(
                this.countdownSeconds,
                59,
            );
        },
